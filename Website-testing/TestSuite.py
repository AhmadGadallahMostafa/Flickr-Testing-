...
upload_test_suite.addTest(
    WebsiteMain.FlickerUpload("test_uploaded_picture_in_photostream")
)
...
#runner = HtmlTestRunner.HTMLTestRunner(
#report_name="Explore Page", report_title="Explore test", combine_reports=True).run(explore_test_suite)
...
runner = HtmlTestRunner.HTMLTestRunner(report_name="Flicker Edit Profile Info tests",
 report_title="edit_profile_info test", combine_reports=True).run(edit_profile_info_test_suite )
